...
External-validation reply update: 2026-08-26 (Asia/Shanghai). The ledger records
...
late replies received through 2026-08-26. Full threads were read; the
...
Status totals (36 meaningful replies):
...
| E04 | Denis Stogl / ros2_control — 2026-08-16 — Gmail `1a009f585690b6e6`; follow-up 2026-08-26 | “Release authority before dispatch” was not understandable from the outreach/site wording. Follow-up guidance noted that unchanged controller/action APIs may still hide execution-relevant ros2_control or hardware_interface lifecycle, resource, timing, and failure changes; the sender described this as speculative guidance, not code validation. | Repeated comprehension evidence plus a generic lower-level provenance requirement; not a support claim. | Public copy explains the boundary. The generic selected-provenance contract binds lower-level execution semantics or an integration-qualified compatibility envelope. **CODE/DOC-FIXED; REFERENCE-CONTRACT; EXTERNAL VALIDATION OPEN**. | Retest comprehension separately. Keep the runtime/API rule adapter-owned; do not add a ros2_control integration or treat speculative guidance as validation. High comprehension-validation value. |
...
There is no unexplained `PARTIAL` or unrepresented generic defect in the 36-row
