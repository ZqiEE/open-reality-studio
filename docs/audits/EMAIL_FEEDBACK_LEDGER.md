...
External-validation reply update: 2026-08-27 (Asia/Shanghai). The ledger records
...
late replies received through 2026-08-27. Full threads were read; the
...
Status totals (37 meaningful replies):

| Status               | Count |
| -------------------- | ----: |
| IMPLEMENTED                                   |    17 |
| REFERENCE-CONTRACT; EXTERNAL TEST OPEN        |     7 |
