...
function main() {
  ...
  assert(labConfigurator.includes("'Safe Rehearsal'") && labConfigurator.includes("'Simulation only · no hardware signal'") && labConfigurator.includes("t(language, 'developer_preview')"), 'Left setup must explain its rehearsal-only purpose and retain the build-boundary disclosure.');
