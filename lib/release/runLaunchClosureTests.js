...
assert(main.includes('snapshot.realDeviceControl') && main.includes('snapshot.simulationToolbarActions === 0') && main.includes('!snapshot.marketplaceTrigger') && main.includes('real_hardware_focus_failed'), 'Packaged REAL acceptance must reject simulation-only toolbar leakage and prove the device-control focus path.');
...
assert(main.includes('snapshot.marketplaceBridge') && main.includes('snapshot.simulationToolbarActions === 5 && snapshot.marketplaceTrigger'), 'Packaged smoke must retain the Marketplace bridge globally but expose its trigger only after entering Simulation Lab.');
...
try {
  ...
  const fixtureDesign = {
    ...
    real_workspace_layouts: [
      { mode: 'real', viewport: { width: 1440, height: 900 }, language: 'zh', toolbar: { realDeviceControl: true, simulationToolbarActions: 0, hardwareFocused: true }, workspaceState: { disconnectedOnboarding: true, realTwinStage: false, canvasCount: 0 }, violations: [] },
      { mode: 'real', viewport: { width: 1440, height: 900 }, language: 'en', toolbar: { realDeviceControl: true, simulationToolbarActions: 0, hardwareFocused: true }, workspaceState: { disconnectedOnboarding: true, realTwinStage: false, canvasCount: 0 }, violations: [] },
      { mode: 'real', viewport: { width: 1180, height: 720 }, language: 'zh', toolbar: { realDeviceControl: true, simulationToolbarActions: 0, hardwareFocused: true }, workspaceState: { disconnectedOnboarding: true, realTwinStage: false, canvasCount: 0 }, violations: [] },
      { mode: 'real', viewport: { width: 1180, height: 720 }, language: 'en', toolbar: { realDeviceControl: true, simulationToolbarActions: 0, hardwareFocused: true }, workspaceState: { disconnectedOnboarding: true, realTwinStage: false, canvasCount: 0 }, violations: [] }
    ],
    layouts: [
      { viewport: { width: 1440, height: 900 }, language: 'zh', toolbar: { realDeviceControl: false, simulationToolbarActions: 5 }, violations: [] },
      { viewport: { width: 1440, height: 900 }, language: 'en', toolbar: { realDeviceControl: false, simulationToolbarActions: 5 }, violations: [] },
      { viewport: { width: 1180, height: 720 }, language: 'zh', toolbar: { realDeviceControl: false, simulationToolbarActions: 5 }, violations: [] },
      { viewport: { width: 1180, height: 720 }, language: 'en', toolbar: { realDeviceControl: false, simulationToolbarActions: 5 }, violations: [] }
    ],
