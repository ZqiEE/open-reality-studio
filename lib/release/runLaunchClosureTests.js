...
assert(main.includes("snapshot.realDeviceWorkspace && snapshot.realModeSelected && snapshot.runControls === 0 && snapshot.stopControls === 0"), 'Packaged first-run smoke must verify the REAL-first workspace without simulation Run/Stop controls.');
...
try {
  ...
  const fixtureDesign = {
    ...
    real_workspace_layouts: [
      { mode: 'real', viewport: { width: 1440, height: 900 }, language: 'zh', violations: [] },
      { mode: 'real', viewport: { width: 1440, height: 900 }, language: 'en', violations: [] },
      { mode: 'real', viewport: { width: 1180, height: 720 }, language: 'zh', violations: [] },
      { mode: 'real', viewport: { width: 1180, height: 720 }, language: 'en', violations: [] }
    ],
    layouts: [
