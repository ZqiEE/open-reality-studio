...
assert(readme.includes('default desktop shell is REAL-device-first') && readme.includes('Simulation is a secondary tool'), 'README must state the REAL-first product and explicit secondary simulation boundary.');
assert(readme.includes('48/48 passing') && readme.includes('5/5'), 'README must publish current automated safety evidence counts.');
